##### Добавить
# ---
# вертикальная линия, которая показывает текущее время, см. plotly stream
# Добавить ввод координат через пробел
# Расстояние до Луны
# Картинки наведения через Aladin Lite
# Темная тема
# Добавить фазу Луны. Рисунок луны и высоту
# Аналогично для Солнца
# Добавить высоту обсерватории
# Добавить выбор даты наблюдения. По умолчанию текущая
